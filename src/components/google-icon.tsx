// Standard "G" mark, inlined so the sign-in button doesn't depend on an
// external image request (the sign-in page is the one screen an unverified
// visitor loads before any auth cookie exists).
